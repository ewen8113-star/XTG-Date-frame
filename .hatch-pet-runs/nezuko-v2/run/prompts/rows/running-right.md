Create one horizontal animation strip for Codex pet `nezuko`, state `running-right`.
...
Identity: same pet in every frame: Preserve the exact chibi pixel-art Nezuko identity, pink eyes, bamboo muzzle, long black hair with orange tips, pink kimono, dark haori, bow, proportions, palette, and crisp pixel edges from the legacy atlas.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `pixel`: Pixel-art-adjacent digital mascot with a chunky silhouette, simple dark outline, limited palette, flat cel shading, and visible stepped edges. User style notes: Match the existing pixel-art atlas exactly; no smoothing, restyling, new props, text, shadows, or detached effects..
